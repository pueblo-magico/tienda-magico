...
5. Mediante un fixture o herramienta administrativa autorizada del entorno aislado, cambiá el estado persistido del pago a `approved`. La página debe mostrar «Pago confirmado» en la siguiente consulta, incluso si el plazo ya venció. No debe continuar consultando automáticamente después de la confirmación.
